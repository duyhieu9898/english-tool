      ...
      <div className="flex-1 flex flex-col max-w-4xl w-full mx-auto relative bg-white dark:bg-gray-800 rounded-3xl border-4 border-black dark:border-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] overflow-hidden">
        ...
        {mode === 'QUIZ' && lesson.questions[currentQuestionIndex] && (
          <div className="p-6 md:p-10 flex flex-col h-full overflow-y-auto">
            <div className="flex justify-between items-center mb-6 border-b-4 border-black dark:border-gray-700 pb-4">
            ...
            {showReference && (
              <div className="mb-8 p-4 bg-amber-50 dark:bg-gray-900 border-4 border-black dark:border-gray-700 rounded-xl max-h-48 overflow-y-auto text-base font-medium leading-relaxed shadow-inner">
                <div className="flex justify-between items-center mb-2 border-b-2 border-black/10 dark:border-white/10 pb-2">
                  <span className="text-xs font-black uppercase opacity-50">Reference Scroll</span>
                </div>
                {lesson.content}
              </div>
            )}
            ...
            <div className="mt-10">
              {!showExplanation ? (
                ...
                <div className="space-y-6">
                  <div className="p-6 bg-lime-200 dark:bg-lime-900/30 text-black dark:text-white rounded-2xl border-4 border-black dark:border-emerald-800">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-blue-500 text-white py-4 px-6 rounded-2xl font-black text-xl uppercase tracking-wider border-4 border-black hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none transition-all"
                  >
